...
namespace PokemonReviewApp
{
    public class Seed
    {
        ...
        public void SeedDataContext()
        {
            ...
            {
                // stores list of PokemonOwners as variable
                var pokemonOwners = new List<PokemonOwner>()
                {
                    // creates new PokemonOwner
                    new PokemonOwner()
                    {
                        // creates new Pokemon as part of PokemonOwner
                        Pokemon = new Pokemon()
                        {
                            Name = "Pikachu",
                            BirthDate = new DateTime(1903,1,1),
                            // creates new PokemonCategories as part of Pokemon
                            PokemonCategories = new List<PokemonCategory>()
                            {
                                new PokemonCategory { Category = new Category () { Name = "Electric" }}
                            },
                            // creates new Review as part of Pokemon
                        ...
                        // creates new Owner as part of PokemonOwner
                        Owner = new Owner()
                        {
                            FirstName = "Jack",
                            LastName = "London",
                            Gym = "Brocks Gym",
                            // creates new Country as part of Owner
                            Country = new Country()
                            {
                                Name = "Kanto"
                            }
